...
class UsersController < ApplicationController
  ...
  def destroy
    @user.destroy
    respond_to do |format|
      format.html { redirect_to users_url, notice: 'Usuario fue eliminado correctamente.' }
  ...
  def crear_usuario_becario
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to @user, notice: 'El Becario fue creado correctamente.' }
        format.json { render :show, status: :created, location: @user }
      else
        format.html { render :new }
        format.json { render json: @user.errors, status: :unprocessable_entity }
  ...
  def crear_usuario_colciencias
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to @user, notice: 'El Usuario Colciencias fue creado correctamente.' }
        format.json { render :show, status: :created, location: @user }
      else
        format.html { render :new }
        format.json { render json: @user.errors, status: :unprocessable_entity }
  ...
  def crear_usuario_evaluador
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to @user, notice: 'El Evaluador fue creado correctamente.' }
        format.json { render :show, status: :created, location: @user }
      else
        format.html { render :new }
        format.json { render json: @user.errors, status: :unprocessable_entity }
