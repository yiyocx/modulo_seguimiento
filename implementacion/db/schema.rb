...
ActiveRecord::Schema.define(version: 20141203070136) do
  ...
  add_index "informes", ["evaluacion_id"], name: "index_informes_on_evaluacion_id", using: :btree
  ...
  add_index "propuesta", ["proyecto_id"], name: "index_propuesta_on_proyecto_id", using: :btree
  ...
  add_index "propuestas", ["evaluacion_id"], name: "index_propuestas_on_evaluacion_id", using: :btree
  add_index "propuestas", ["proyecto_id"], name: "index_propuestas_on_proyecto_id", using: :btree
  ...
  add_index "users", ["usuario_col_id"], name: "index_users_on_usuario_col_id", using: :btree
  ...
  add_index "usuario_cols", ["user_id"], name: "index_usuario_cols_on_user_id", using: :btree
