...
# Test para el Controlador Desembolsos
class DesembolsosControllerTest < ActionController::TestCase
  ...
  test 'should create desembolso' do
    assert_difference('Desembolso.count') do
      post :create,
           desembolso: {
             condiciones: @desembolso.condiciones,
             estado: @desembolso.estado,
             fecha_giro: @desembolso.fecha_giro,
             fecha_solicitud: @desembolso.fecha_solicitud,
             girado: @desembolso.girado,
