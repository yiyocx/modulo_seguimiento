...
class PropuestasControllerTest < ActionController::TestCase
  ...
  test "should create propuesta" do
    assert_difference('Propuesta.count') do
      post :create, propuesta: { estado: @propuesta.estado, nombre: @propuesta.nombre, numero: @propuesta.numero, proyecto_id: @propuesta.proyecto_id }
    end
  ...
  test "should update propuesta" do
    patch :update, id: @propuesta, propuesta: { estado: @propuesta.estado, nombre: @propuesta.nombre, numero: @propuesta.numero, proyecto_id: @propuesta.proyecto_id }
    assert_redirected_to propuesta_path(assigns(:propuesta))
  end
