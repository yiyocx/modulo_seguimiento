...
# Test para el Controlador VisitaTecnica
class VisitaTecnicasControllerTest < ActionController::TestCase
  ...
  test 'should create visita_tecnica' do
    assert_difference('VisitaTecnica.count') do
      post :create, visita_tecnica: {
        observacion: @visita_tecnica.observacion,
        porc_cumplimiento: @visita_tecnica.porc_cumplimiento,
        tipo_proyeccion: @visita_tecnica.tipo_proyeccion }
    end
  ...
  test 'should update visita_tecnica' do
    patch :update, id: @visita_tecnica,
                   visita_tecnica: {
                     observacion: @visita_tecnica.observacion,
                     porc_cumplimiento: @visita_tecnica.porc_cumplimiento,
                     tipo_proyeccion: @visita_tecnica.tipo_proyeccion }
